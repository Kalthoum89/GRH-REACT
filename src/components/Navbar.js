                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        <li className="nav-item">
                            <a className="nav-link active" aria-current="page" href="/candidats">Candidats</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link" href="/recrues">Recrues</a>
                        </li>
                    ...
                    <ul className="navbar-nav ml-auto">
                        <li className="nav-item dropdown">
                            <a className="nav-link dropdown-toggle" id="navbardrop" data-bs-toggle="dropdown">
                                <i class="fa fa-user-circle fs-3 text-success" aria-hidden="true"></i>
                            </a>
