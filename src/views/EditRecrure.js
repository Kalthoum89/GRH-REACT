...
export default function EditRecrure() {
    const { id } = useParams()
    const RecrureCtx = useContext(RecrureContext);
    const [loading, setloading] = useState(true)
    var ctx = RecrureCtx?.recrues[id]
    ...
    const onChangeCandidat = ()=>{
        ...
        var array = [...RecrureCtx?.recrues]
        array[id] = ctx
        localStorage.setItem("recrues",JSON.stringify(array))
